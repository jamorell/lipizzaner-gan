...
WIDTH = 28
HEIGHT = 28
ELEMENTS_PER_LABEL = 109



class HMNISTBalancedDataLoader(DataLoader):

    def __init__(self, use_batch=True, batch_size=1, n_batches=0, shuffle=False):
        super().__init__(HMNISTBalancedDataSet, use_batch, batch_size, n_batches, shuffle)
...
class HMNISTBalancedDataSet(Dataset):
