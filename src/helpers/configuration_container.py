...
class ConfigurationContainer:
    class_maps = {
        ...
        #'hmnist': ('data.hmnist_data_loader', 'HMNISTDataLoader'),
	#'mnist': ('data.hmnist_data_loader', 'HMNISTDataLoader'),
	'mnist': ('data.hmnist_balanced_data_loader', 'HMNISTBalancedDataLoader'),
